...
const routeConfig = {
  ...
  '/content/music': { label: 'Music', icon: '🎵' },
  '/chat': { label: 'AI Chat', icon: '💬' },
  '/tina': { label: 'Tina AI', icon: '🧠' },
  '/tina/strategies': { label: 'Strategies', icon: '🎯' },
  '/tina/goals': { label: 'Goals', icon: '🎯' },
  '/tina/experiments': { label: 'Experiments', icon: '🧪' },
  '/tina/learnings': { label: 'Learnings', icon: '💡' },
  '/tina/thoughts': { label: 'Thoughts', icon: '🧠' },
  '/tina/inbox': { label: 'Inbox', icon: '📬' },
  '/tina/plans': { label: 'Plans', icon: '📋' },
  '/tina/reflections': { label: 'Reflections', icon: '📝' },
  '/ads': { label: 'Ads', icon: '📢' },
