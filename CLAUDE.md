...
This command **requires** the project directory as an argument via `C:\Projects\blush-marketing`.

**Example:** `/create-spec generations/my-app`

**Output location:** `C:\Projects\blush-marketing/prompts/app_spec.txt` and `C:\Projects\blush-marketing/prompts/initializer_prompt.md`

If `C:\Projects\blush-marketing` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `C:\Projects\blush-marketing/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `C:\Projects\blush-marketing/prompts/app_spec.txt`
...
**Output path:** `C:\Projects\blush-marketing/prompts/initializer_prompt.md`
...
**Output path:** `C:\Projects\blush-marketing/prompts/.spec_status.json`
...
> "Your specification files have been created in `C:\Projects\blush-marketing/prompts/`!
>
> **Files created:**
> - `C:\Projects\blush-marketing/prompts/app_spec.txt`
> - `C:\Projects\blush-marketing/prompts/initializer_prompt.md`
>
