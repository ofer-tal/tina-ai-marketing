...
async function main() {
  ...
  // Get the recent create_post proposals with full details
  ...
  console.log('\n=== Recent create_post Tool Proposals ===\n');
  ...
  for (const p of proposals) {
    ...
    if (p.parameters) {
      ...
      console.log('  scheduledAt:', p.parameters.scheduledAt);
      console.log('  storyId:', p.parameters.storyId?.substring(0, 10) + '...');
    }
    console.log('');
  }
