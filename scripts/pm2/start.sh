...
case "$MODE" in
  dev)
    ...
    echo ""
    run_pm2 start ecosystem/ecosystem.config.cjs --env development
    ;;
  dev-watch)
    ...
    echo ""
    run_pm2 start ecosystem/ecosystem.config.cjs --env development --watch
    ;;
  production)
    ...
    echo ""
    run_pm2 start ecosystem/ecosystem.config.cjs --env production
    ;;
esac
